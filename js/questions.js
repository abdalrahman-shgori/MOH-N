...
const questionsAr = [
    ...
    {
        question: "أيها من العبارات التالية تصف وضعك بشكل أفضل",
        answers: [
    ...
    {
        question: "منذ متى بدأت ممارسة المشي",
        answers: [
    ...
    {
        question: "أثناء المشي، هل تشعر بالعرق وارتفاع ضربات القلب",
        answers: [
            { text: "نعم", value: 0 },
            { text: "لا", value: 0 },
        ],
    ...
    {
        question: "أيها من العبارات التالية تصف وضعك",
        answers: [
    ...
    {
        question: "هل لديك أسباب تمنعك من المشي",
        answers: [
    ...
    {
        question: "ما هي الأسباب التي تشجعك على ممارسة المشي",
        answers: [
    ...
    {
        question: "ما هي الأماكن التي تفضلها عند ممارسة المشي",
        answers: [
